...
inherits(DHCP, noodles);

function DHCP(config, onListening) {
	if (!(this instanceof DHCP)) return new DHCP(config, onListening);
 ...
 */
DHCP.prototype._respond = function(msg, fields, options, cb) {
